...
# choose = "input"
# binsize = 1000
# root_path = "/share/data6/tmp/renjun/ExtraJobs/202305_RIPseq_analysis/"
...
source(paste0(root_path,"/0_RIPSeeker.R"))
...
## 2. 获取原始bam文件的完整路径
bam_path = paste0(root_path, "/3_sequence_bowtie2/", choose, "/split")
...
# bamfilex = "/share/data6/tmp/renjun/ExtraJobs/202305_RIPseq_analysis/3_sequence_bowtie2/input/input.sorted.redup.bam"
